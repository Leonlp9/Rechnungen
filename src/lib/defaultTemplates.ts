...
const sharedVars: TemplateVariable[] = [
  ...
  { key: 'receiver_name', label: 'EmpfÃ¤nger Name', defaultValue: '', settingsKey: '', multiline: false },
  { key: 'receiver_address', label: 'EmpfÃ¤nger Adresse', defaultValue: '', settingsKey: '', multiline: true },
  ...
  { key: 'due_date', label: 'FÃ¤llig bis', defaultValue: '', settingsKey: '', multiline: false },
  { key: 'notes', label: 'Hinweise', defaultValue: 'Zahlung per Ãœberweisung innerhalb von 14 Tagen nach Erhalt der Rechnung.', settingsKey: '', multiline: true },
  // Auto-calculated from line items â€“ not shown as manual inputs
  { key: 'netto', label: 'Nettobetrag', defaultValue: '0,00 â‚¬', settingsKey: '', multiline: false, autoCalculated: true },
  { key: 'vat_amount', label: 'MwSt. Betrag', defaultValue: '0,00 â‚¬', settingsKey: '', multiline: false, autoCalculated: true },
  { key: 'total', label: 'Gesamtbetrag (Brutto)', defaultValue: '0,00 â‚¬', settingsKey: '', multiline: false, autoCalculated: true },
];
...
function buildInvoiceElements(titleText: string, titleColor: string): TemplateElement[] {
  return [
    ...
    // â”€â”€ Invoice meta box (top right) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    { id: uid(), type: 'text', x: 504, y: 171, width: 120, height: 18, zIndex: 3, content: 'FÃ¤llig bis:', fontSize: 9, fontWeight: 'normal', fontStyle: 'normal', color: '#888', backgroundColor: 'transparent', textAlign: 'left', lineHeight: 1.2 },
    ...
    // â”€â”€ Receiver â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    { id: uid(), type: 'text', x: 30, y: 118, width: 250, height: 16, zIndex: 2, content: 'RechnungsempfÃ¤nger', fontSize: 8, fontWeight: 'normal', fontStyle: 'normal', color: '#bbb', backgroundColor: 'transparent', textAlign: 'left', lineHeight: 1.2 },
    ...
    // â”€â”€ Items table (dynamic) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    {
      id: uid(), type: 'items',
    ...
    // â”€â”€ Totals box â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Bank info â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    { id: uid(), type: 'text', x: 0, y: 1100, width: 794, height: 18, zIndex: 2, content: 'Vielen Dank fÃ¼r Ihren Auftrag!', fontSize: 9, fontWeight: 'normal', fontStyle: 'normal', color: '#bbb', backgroundColor: 'transparent', textAlign: 'center', lineHeight: 1.2 },
  ] as TemplateElement[];
}
...
export const DEFAULT_GUTSCHRIFT: InvoiceTemplate = {
  ...
  variables: sharedVars.map(v =>
    ...
    v.key === 'due_date' ? { ...v, label: 'Gutschrift gÃ¼ltig bis' } : v
  ),
