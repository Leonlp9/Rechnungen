...
const sharedVars: TemplateVariable[] = [
  ...
  { key: 'items', label: 'Positionen', defaultValue: '1x Leistung XY                                   100,00 €\n1x Weitere Leistung                               200,00 €', settingsKey: '', multiline: true },
  { key: 'netto', label: 'Nettobetrag', defaultValue: '0,00 €', settingsKey: '', multiline: false },
  { key: 'vat_amount', label: 'MwSt. Betrag', defaultValue: '0,00 €', settingsKey: '', multiline: false },
  { key: 'total', label: 'Gesamtbetrag (Brutto)', defaultValue: '0,00 €', settingsKey: '', multiline: false },
...
function buildInvoiceElements(titleText: string, titleColor: string): TemplateElement[] {
  return [
    ...
    // ── Items table ─────────────────────────────────────────
    { id: uid(), type: 'rectangle', x: 30, y: 222, width: 734, height: 26, zIndex: 1, backgroundColor: titleColor, borderColor: 'transparent', borderWidth: 0, borderRadius: 4 },
    { id: uid(), type: 'text', x: 40, y: 228, width: 500, height: 18, zIndex: 3, content: 'Beschreibung', fontSize: 9, fontWeight: 'bold', fontStyle: 'normal', color: '#fff', backgroundColor: 'transparent', textAlign: 'left', lineHeight: 1.2 },
    { id: uid(), type: 'text', x: 590, y: 228, width: 164, height: 18, zIndex: 3, content: 'Gesamt', fontSize: 9, fontWeight: 'bold', fontStyle: 'normal', color: '#fff', backgroundColor: 'transparent', textAlign: 'right', lineHeight: 1.2 },
    // Items body
    { id: uid(), type: 'variable', x: 30, y: 248, width: 734, height: 200, zIndex: 2, variableKey: 'items', prefix: '', suffix: '', fontSize: 9, fontWeight: 'normal', fontStyle: 'normal', color: '#222', backgroundColor: 'transparent', textAlign: 'left', lineHeight: 1.7 },
    // Items bottom border
    { id: uid(), type: 'rectangle', x: 30, y: 448, width: 734, height: 1, zIndex: 2, backgroundColor: '#e2e8f0', borderColor: 'transparent', borderWidth: 0, borderRadius: 0 },

    // ── Totals box ──────────────────────────────────────────
    { id: uid(), type: 'rectangle', x: 494, y: 462, width: 270, height: 110, zIndex: 1, backgroundColor: '#f8fafc', borderColor: '#e2e8f0', borderWidth: 1, borderRadius: 6 },
    { id: uid(), type: 'text', x: 504, y: 474, width: 130, height: 18, zIndex: 3, content: 'Netto:', fontSize: 9, fontWeight: 'normal', fontStyle: 'normal', color: '#666', backgroundColor: 'transparent', textAlign: 'left', lineHeight: 1.2 },
    { id: uid(), type: 'variable', x: 634, y: 474, width: 120, height: 18, zIndex: 3, variableKey: 'netto', prefix: '', suffix: '', fontSize: 9, fontWeight: 'normal', fontStyle: 'normal', color: '#222', backgroundColor: 'transparent', textAlign: 'right', lineHeight: 1.2 },
    { id: uid(), type: 'text', x: 504, y: 496, width: 130, height: 18, zIndex: 3, content: 'MwSt.:', fontSize: 9, fontWeight: 'normal', fontStyle: 'normal', color: '#666', backgroundColor: 'transparent', textAlign: 'left', lineHeight: 1.2 },
    { id: uid(), type: 'variable', x: 634, y: 496, width: 120, height: 18, zIndex: 3, variableKey: 'vat_amount', prefix: '', suffix: '', fontSize: 9, fontWeight: 'normal', fontStyle: 'normal', color: '#222', backgroundColor: 'transparent', textAlign: 'right', lineHeight: 1.2 },
    { id: uid(), type: 'rectangle', x: 504, y: 518, width: 250, height: 1, zIndex: 2, backgroundColor: '#cbd5e1', borderColor: 'transparent', borderWidth: 0, borderRadius: 0 },
    { id: uid(), type: 'text', x: 504, y: 524, width: 130, height: 24, zIndex: 3, content: 'Gesamt:', fontSize: 11, fontWeight: 'bold', fontStyle: 'normal', color: '#111', backgroundColor: 'transparent', textAlign: 'left', lineHeight: 1.2 },
    { id: uid(), type: 'variable', x: 560, y: 524, width: 194, height: 24, zIndex: 3, variableKey: 'total', prefix: '', suffix: '', fontSize: 13, fontWeight: 'bold', fontStyle: 'normal', color: titleColor, backgroundColor: 'transparent', textAlign: 'right', lineHeight: 1.2 },

    // ── Notes ───────────────────────────────────────────────
    { id: uid(), type: 'text', x: 30, y: 466, width: 400, height: 16, zIndex: 2, content: 'Hinweise:', fontSize: 8, fontWeight: 'bold', fontStyle: 'normal', color: '#bbb', backgroundColor: 'transparent', textAlign: 'left', lineHeight: 1.2 },
    { id: uid(), type: 'variable', x: 30, y: 484, width: 420, height: 55, zIndex: 2, variableKey: 'notes', prefix: '', suffix: '', fontSize: 9, fontWeight: 'normal', fontStyle: 'normal', color: '#555', backgroundColor: 'transparent', textAlign: 'left', lineHeight: 1.5 },

    // ── Bank info ───────────────────────────────────────────
    { id: uid(), type: 'text', x: 30, y: 580, width: 300, height: 16, zIndex: 2, content: 'Bankverbindung:', fontSize: 8, fontWeight: 'bold', fontStyle: 'normal', color: '#bbb', backgroundColor: 'transparent', textAlign: 'left', lineHeight: 1.2 },
    { id: uid(), type: 'variable', x: 30, y: 598, width: 420, height: 18, zIndex: 2, variableKey: 'sender_iban', prefix: 'IBAN: ', suffix: '', fontSize: 9, fontWeight: 'normal', fontStyle: 'normal', color: '#444', backgroundColor: 'transparent', textAlign: 'left', lineHeight: 1.2 },
    { id: uid(), type: 'variable', x: 30, y: 618, width: 420, height: 18, zIndex: 2, variableKey: 'sender_bic', prefix: 'BIC: ', suffix: '', fontSize: 9, fontWeight: 'normal', fontStyle: 'normal', color: '#444', backgroundColor: 'transparent', textAlign: 'left', lineHeight: 1.2 },
    { id: uid(), type: 'variable', x: 30, y: 640, width: 420, height: 18, zIndex: 2, variableKey: 'sender_tax_number', prefix: 'St.-Nr.: ', suffix: '', fontSize: 9, fontWeight: 'normal', fontStyle: 'normal', color: '#444', backgroundColor: 'transparent', textAlign: 'left', lineHeight: 1.2 },
    { id: uid(), type: 'variable', x: 30, y: 660, width: 420, height: 18, zIndex: 2, variableKey: 'sender_vat_id', prefix: 'USt-IdNr.: ', suffix: '', fontSize: 9, fontWeight: 'normal', fontStyle: 'normal', color: '#444', backgroundColor: 'transparent', textAlign: 'left', lineHeight: 1.2 },
