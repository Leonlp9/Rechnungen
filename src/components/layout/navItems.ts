...
export const NAV_ITEMS: NavItem[] = [
  ...
  { to: '/write-invoice', tint: 'orange', label: 'Rechnung schreiben', icon: FilePlus2, tutorialId: 'nav-write-invoice', group: 'Belege', hint: 'Ausgangsrechnung erstellen' },
  { to: '/invoice-designer', tint: 'purple', label: 'Template Designer', icon: PenSquare, tutorialId: 'nav-invoice-designer', group: 'Belege', hint: 'Rechnungsvorlagen gestalten', desktopOnly: true },

  { to: '/customers', tint: 'teal', label: 'Kunden', icon: Users, tutorialId: 'nav-customers', group: 'Organisation', hint: 'Kundenstamm' },
  { to: '/projects', tint: 'yellow', label: 'Projekte', icon: FolderKanban, tutorialId: 'nav-projects', group: 'Organisation', hint: 'Belege nach Projekt' },
  ...
  { to: '/krankenkasse', tint: 'red', label: 'Krankenkasse', icon: HeartPulse, tutorialId: 'nav-krankenkasse', group: 'Auswertung', hint: 'Beiträge & Sätze' },
