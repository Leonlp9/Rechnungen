...
export function DashboardEditSidebar({ onClose, onReset }: DashboardEditSidebarProps) {
  ...
  const allItems: SidebarItemDef[] = [
    ...
    { section: 'Kennzahlen', type: 'kpi-betriebsergebnis', label: 'Cash-Gewinn', icon: <Calculator className="h-4 w-4 text-violet-600" />, description: 'Cashflow-Betriebsergebnis', tooltip: 'Einnahmen abzüglich aller Betriebsausgaben mit vollem Kaufpreis (ohne AfA-Korrektur). Zeigt, wie viel echtes Geld auf dem Konto geblieben ist.' },
    { section: 'Kennzahlen', type: 'kpi-betriebsergebnis-afa', label: 'Steuerlicher Gewinn (EÜR)', icon: <Calculator className="h-4 w-4 text-amber-600" />, description: 'Gewinn nach AfA-Korrektur', tooltip: 'Einnahmen minus Betriebsausgaben mit zeitanteiliger AfA statt vollem Kaufpreis. Das ist der Betrag, den das Finanzamt als Gewinn wertet – Basis für die Einkommensteuer. Nutze diesen Wert für deine Steuerrücklage!' },
    ...
    { section: 'Statistiken', type: 'chart-afa-typ', label: 'AfA nach Typ (Balken)', icon: <Calculator className="h-4 w-4 text-violet-500" />, description: 'Abschreibung nach Wirtschaftsgut-Typ', tooltip: 'Horizontales Balkendiagramm, das die jährliche AfA nach Wirtschaftsgut-Typ (Computer, Smartphone, Kamera etc.) aufschlüsselt.' },
    { section: 'Statistiken', type: 'chart-afa-donut', label: 'AfA-Verteilung (Donut)', icon: <PieChart className="h-4 w-4 text-violet-400" />, description: 'Prozentuale AfA-Verteilung nach Typ', tooltip: 'Ringdiagramm, das zeigt, wie sich die jährliche Abschreibung auf die verschiedenen Wirtschaftsgut-Typen verteilt.' },
    { section: 'Statistiken', type: 'chart-afa-timeline', label: 'AfA-Zeitverlauf', icon: <Activity className="h-4 w-4 text-violet-500" />, description: 'Abschreibung aller Geräte über die Zeit', tooltip: 'Gestapeltes Flächendiagramm, das die AfA aller Wirtschaftsgüter über die gesamte Nutzungsdauer zeigt. Umschaltbar zwischen jährlicher und monatlicher Ansicht – so siehst du, wann welches Gerät abgeschrieben ist und wie sich die Gesamtbelastung entwickelt.' },
    // Listen
    ...
    { section: 'Listen', type: 'card-afa-uebersicht', label: 'AfA & GWG Übersicht', icon: <Calculator className="h-4 w-4 text-violet-500" />, description: 'Wirtschaftsgüter mit Abschreibung', tooltip: 'Zeigt alle Belege mit Kategorie „AfA" oder „GWG", deren Netto-Schwelle, empfohlene Abschreibungsmethode und die jährliche Abschreibungssumme. Warnt bei falscher Kategorie-Zuordnung.' },
    { section: 'Kennzahlen', type: 'kpi-afa-jahres', label: 'AfA-Abschreibung (Jahr)', icon: <Calculator className="h-4 w-4 text-violet-500" />, description: 'Zeitanteilige Jahres-AfA', tooltip: 'Zeigt die Summe aller zeitanteiligen Abschreibungen (AfA + GWG-Sofortabzüge) für das ausgewählte Jahr. Dieser Betrag ist in der EÜR als Betriebsausgabe absetzbar.' },
  ];
