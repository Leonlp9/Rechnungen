...
export function TopAusgabenCard({ loading, invoices, privacyMode }: Props) {
  ...
  return (
    <div className="rounded-xl border bg-card p-6 shadow-sm h-full flex flex-col">
      <h2 className="text-lg font-semibold mb-1">Top 5 Ausgaben</h2>
      <p className="text-xs text-muted-foreground mb-4">Größte Einzelausgaben im gewählten Jahr</p>
      {loading ? (
