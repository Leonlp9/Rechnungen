                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1.5">
                        <Label className="flex items-center gap-1">
                          Netto
                          <InfoTooltip text="Nettobetrag: Rechnungsbetrag ohne Umsatzsteuer. Basis für steuerliche Berechnungen (EÜR)." side="top" />
                        </Label>
                      ...
                      <div className="space-y-1.5">
                        <Label className="flex items-center gap-1">
                          USt
                          <InfoTooltip text="Umsatzsteuer (auch MwSt.): Steuer die auf den Nettobetrag aufgeschlagen wird. Als Kleinunternehmer (§ 19 UStG) weist du keine USt aus → hier 0 eintragen." side="top" />
                        </Label>
                      ...
                      <div className="space-y-1.5">
                        <Label className="flex items-center gap-1">
                          Gebuehren (Fee)
                          <InfoTooltip text="Plattformgebühren oder Transaktionskosten, die beim Zahlungseingang abgezogen werden (z. B. PayPal, Stripe). Werden separat gespeichert." side="top" />
                        </Label>
                      ...
                      <div className="space-y-1.5">
                        <Label className="flex items-center gap-1">
                          Brutto
                          <InfoTooltip text="Bruttobetrag: Netto + USt = Gesamtbetrag der Rechnung. Dieser Betrag wird für die Kleinunternehmergrenze (§ 19 UStG) verwendet." side="top" />
                        </Label>
                      ...
                      <div className="space-y-1.5">
                        <Label className="flex items-center gap-1">
                          Typ
                          <InfoTooltip text="Einnahme = Geld erhalten (z. B. Honorar). Ausgabe = Geld bezahlt (z. B. Software-Abo). Info = neutraler Vermerk ohne Buchungswirkung." side="top" />
                        </Label>
                      ...
                      <div className="space-y-1.5">
                        <Label className="flex items-center gap-1">
                          Kategorie
                          <InfoTooltip text="Kategorien helfen bei der steuerlichen Einordnung. Einnahmen: z. B. Honorar, Provision. Ausgaben: z. B. Software/Abos, Bürobedarf, Fahrtkosten. Anlagevermögen wird per AfA abgeschrieben." side="top" />
                        </Label>
