...
const ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    icon: Tag,
    category: 'Rechnungen',
    keywords: ['kategorie', 'einnahme', 'ausgabe', 'afa', 'gwg', 'software', 'abo', 'fremdleistung', 'vertrag', 'steuer'],
    content: (
      <div className="space-y-4">
        <p className="text-muted-foreground">
          Die Kategorie bestimmt die steuerliche Einordnung einer Buchung.
        </p>
        ...
        <Tip>Die KI-Erkennung schlägt automatisch eine Kategorie vor – du kannst sie jederzeit ändern.</Tip>
      </div>
    ),
  },
  {
